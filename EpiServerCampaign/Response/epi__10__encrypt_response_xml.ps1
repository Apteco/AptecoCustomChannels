...
# settings
$inputfile = $settings.inputConfig
$outputfile = $settings.outputConfig
...
# TODO [ ] ask if input file should be replaced or deleted
Remove-Item -Path $inputfile
Move-Item -Path $outputfile -Destination $inputfile
