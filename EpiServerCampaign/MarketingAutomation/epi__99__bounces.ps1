...
#$bounces = Get-EpiResponses -responseType Bounces -maxDays $maxDays
...
Invoke-Epi -webservice "Response" -method "getAllRecipientResponseCounts2" -param @("hardbounce") -useSessionId $true #-verboseCall
    #($currentTimestamp - $secondsForXDays),$currentTimestamp,@{value=0;datatype="int"},@{value=1;datatype="int"}
