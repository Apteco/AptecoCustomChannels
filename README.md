...
Mailchimp||REST|:heavy_check_mark:/:heavy_check_mark:GetMessages<br/>:heavy_check_mark:/:heavy_check_mark:SendTest<br/>:heavy_check_mark:/:o:PreviewMessage<br/>:x:/:x:PreviewMessagePersonalised<br/>:heavy_check_mark:/:heavy_check_mark:Upload<br/>:heavy_check_mark:/:heavy_check_mark:Broadcast<br/>:x:/:x: Response Download<br/>:x:/:x:Trigger FERGE|Sample implementation demonstrated at Apteco Live 2022. [Mailchimp Integration Guideline](Mailchimp)
